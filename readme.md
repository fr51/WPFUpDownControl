...
2. In your project, add a reference to the DLL file you just downloaded
...
```xaml
<local:WPFUpDownControl CurrentValue="5.1" Step="0.75" MinValue="1" MaxValue="10.999"/>
```
...
```xaml
<local:WPFUpDownControl CurrentValue="5.1" Step="0.75" MinValue="1" MaxValue="10.999" CurrentValueChanged="WUDC_CurrentValueChanged" StepChanged="WUDC_StepChanged" MinValueChanged="WUDC_MinValueChanged" MaxValueChanged="WUDC_MaxValueChanged"/>
```
...
Tests will be functional ones and performed manually. They will include the following:
